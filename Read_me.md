# I am going to set up my Public Repo to document the commands I take.
'''I set up folders and navigated to them'''
cd DavesPublicRepos
cd DavesPublicRepo1
git config --global user.name "Dave Martin"
git config--global user.email "david.michael.martin1@gmail.com"   
git config --global color.ui auto
''' I set up a repo on the website: https://github.com/davidmichaelmartin1'''

git clone https://github.com/davidmichaelmartin1/DavesPublicRepo1.git
...
mv terraform-azure.pem.pub terraform-azure.pub
didnt work "no such file or directory"
mv /Users/davidmartin/Desktop/Divergence/DavesPublicRepos/DavesPublicRepo1/terraform-manifests/ssh-keys/-f terraform-azure.pem.pub /Users/davidmartin/Desktop/Divergence/DavesPublicRepos/DavesPublicRepo1/terraform-manifests/ssh-keys/-f terraform-azure.pub
didnt work "terraform-azure.pub is not a directory"
'''I manually changed file name to remove the -f and space... from "-f terraform-azure.pem.pub" to "terraform-azure.pem.pub" and retried last command.'''
it worked.
...
''' I backed back out to terraform-manifests file because it seemed appropriate '''
cd ..
touch c7-01-web-linuxvm-input-variables.tf
...
resource "azurerm_public_ip" "web_linuxvm_publicip" {
  ...
  '''copying all this into CLI did not work... trying line by line
  line by line didnt work
  so i created a file and put this information into it... 
  '''
  touch c7-02-web-linuxvm-publicip.tf

  ''' I pasted above into the new file and got the following error...
  "No declaration found for "local.resource_name_prefix"Terraform" 
  cant figure it out. perhaps I need to define a variable in a subsequent step... Moving on for now. '''
...
touch c7-03-web-linuxvm-network-interface.tf
''' pasted below instructions in and got same error as above... skipping ahead'''
```t
...
touch c7-04-web-linuxvm-network-security-group.tf 
''' pasted everything down to line 197 into new file '''
```t
...
touch c7-05-web-linuxvm-resource.tf
# ''' pasted everything below and got same error as above'''
...
touch c7-06-web-linuxvm-outputs.tf
...
# Terraform Validate
terraform validate
''' I keep erroring out here because of undeclared resources in root module... 
